  ...
  es: {
    ...
    education: [
      ...
      },
      {
        ...
        institution:
          "Corporacion Universitaria Empresarial de Salamanca (CUES)",
        period: "2007 - 2012",
      },
    ],
    skills: [
      {
        ...
        level: 9,
        description:
          "Lenguaje de programación principal para el desarrollo en el ecosistema .NET.",
      },
      {
        name: ".Net Core",
        level: 9,
        description:
          "Framework moderno y multiplataforma para construir aplicaciones de alto rendimiento.",
      },
      {
        name: "API Rest",
        level: 9,
        description:
          "Diseño y construcción de servicios web RESTful para la comunicación entre aplicaciones.",
      },
      {
        name: "SQL Server",
        level: 9,
        description:
          "Gestión y consulta de bases de datos relacionales de Microsoft.",
      },
      {
        name: "JavaScript",
        level: 6,
        description:
          "Lenguaje fundamental para la interactividad en el desarrollo web front-end.",
      },
      {
        name: "HTML5 & CSS3",
        level: 6,
        description:
          "Estructuración y estilización de contenido web moderno y responsivo.",
      },
      {
        name: ".Net Framework",
        level: 8,
        description:
          "Framework tradicional de .NET para la creación de aplicaciones Windows y web.",
      },
      {
        name: "MVC",
        level: 8,
        description:
          "Patrón de arquitectura para organizar aplicaciones en Modelo-Vista-Controlador.",
      },
      {
        name: "React.js",
        level: 5,
      ...
      },
      {
        ...
        level: 7,
        description:
          "Plataforma en la nube de Microsoft para desplegar y gestionar servicios.",
      },
      {
        name: "Docker",
        level: 4,
        description:
          "Plataforma de contenedores para construir, distribuir y ejecutar aplicaciones.",
      },
      {
        name: "Node.js",
        level: 4,
      ...
      },
      {
        ...
        level: 3,
        description:
          "Framework para el desarrollo de aplicaciones a gran escala y nivel empresarial.",
      },
      {
        name: "VueJs",
        level: 4,
      ...
      },
      {
        ...
        level: 4,
        description:
          "Plataforma de Amazon Web Services para servicios en la nube.",
      },
      {
        name: "SSIS",
        level: 5,
        description:
          "Herramienta de SQL Server para la integración de datos y flujos de trabajo ETL.",
      },
    ],
    languages: [
    ...
    skills: [
      {
        ...
        level: 9,
        description:
          "Primary programming language for development in the .NET ecosystem.",
      },
      {
        name: ".Net Core",
        level: 9,
      ...
      },
      {
        ...
        level: 9,
        description:
          "Designing and building RESTful web services for application communication.",
      },
      {
        name: "SQL Server",
        level: 9,
        description:
          "Management and querying of Microsoft's relational databases.",
      },
      {
        name: "JavaScript",
        level: 6,
        description:
          "Fundamental language for interactivity in front-end web development.",
      },
      {
        name: "HTML5 & CSS3",
        level: 6,
        description: "Structuring and styling modern, responsive web content.",
      },
      {
        name: ".Net Framework",
        level: 8,
        description:
          "Traditional .NET framework for creating Windows and web applications.",
      },
      {
        name: "MVC",
        level: 8,
        description:
          "Architectural pattern for organizing applications into Model-View-Controller.",
      },
      {
        name: "React.js",
        level: 5,
      ...
      },
      {
        ...
        level: 7,
        description:
          "Microsoft's cloud platform for deploying and managing services.",
      },
      {
        name: "Docker",
        level: 4,
        description:
          "Containerization platform to build, ship, and run applications.",
      },
      {
        name: "Node.js",
        level: 4,
      ...
      },
      {
        ...
        level: 3,
        description:
          "Framework for developing large-scale, enterprise-level applications.",
      },
      {
        name: "VueJs",
        level: 4,
      ...
      },
      {
        name: "AWS",
        level: 4,
        description: "Amazon Web Services platform for cloud services.",
      },
      {
        name: "SSIS",
        level: 5,
        description: "SQL Server tool for data integration and ETL workflows.",
      },
    ],
    languages: [
